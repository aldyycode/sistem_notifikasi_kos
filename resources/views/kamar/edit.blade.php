...
<div class="p-6 max-w-4xl mx-auto">
    ...
    {{-- HEADER HALAMAN --}}
    <div class="mb-6">
        <h2 class="text-2xl font-semibold text-slate-900">Edit Data Kamar</h2>
        <p class="text-sm text-slate-500 mt-1">Perbarui spesifikasi, harga, atau status ketersediaan kamar.</p>
    </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select name="status_kamar" class="w-full px-4 py-2.5 rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-slate-800 focus:border-slate-800 transition-colors bg-white" required>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="fasilitas" 
                                      ...
                                      placeholder="Contoh: AC, Kasur Springbed, Lemari Pakaian, Kamar Mandi Dalam">{{ old('fasilitas', $kamar->fasilitas) }}</textarea>
                        </div>
